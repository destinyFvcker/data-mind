...
impl DingTalkRobotReq {
    pub async fn send_text_msg(
        ...
        ding_robot::msg_client::ding_text(
            reqwest_client,
    ...
    pub async fn send_markdown_msg(
        ...
        ding_robot::msg_client::ding_markdown(
            reqwest_client,
            &self.webhook_address,
            &self.key_signature,
            markdown_content,
    ...
    pub async fn ping(&self, reqwest_client: &reqwest::Client) -> anyhow::Result<()> {
        ding_robot::msg_client::ding_ping(
            reqwest_client,
            &self.webhook_address,
            &self.key_signature,
        )
